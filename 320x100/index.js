...
lib.ssMetadata = [
		{name:"index_atlas_1", frames: [[500,529,273,45],[285,418,495,62],[0,320,283,118],[0,482,498,45],[500,482,498,45],[0,529,498,45],[782,428,223,45],[502,0,310,231],[502,233,300,183],[0,0,500,318],[804,233,200,193]]}
];
...
if (reversed == null) { reversed = false; }
	...
	this.instance.setTransform(-10,-4,0.3,0.3);

	this.timeline.addTween(cjs.Tween.get(this.instance).wait(1));

	this._renderFirstFrame();

}).prototype = getMCSymbolPrototype(lib.Symbol1, new cjs.Rectangle(-10,-4,150,95.4), null);
...
if (reversed == null) { reversed = false; }
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_9).wait(219).to({_off:false},0).to({regX:70.8,regY:19.2,scaleX:0.7726,scaleY:0.7726,x:233.25,y:18},10,cjs.Ease.get(1)).wait(21));
...
p.nominalBounds = new cjs.Rectangle(185.2,32.5,318.8,103.69999999999999);
// library properties:
lib.properties = {
	...
	opacity: 1.00,
	manifest: [
		{src:"images/index_atlas_1.png?1599707018715", id:"index_atlas_1"}
	],
	preloads: []
};
