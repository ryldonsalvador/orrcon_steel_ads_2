...
lib.ssMetadata = [
		{name:"index_atlas_1", frames: [[0,596,273,45],[302,414,495,62],[502,0,431,179],[799,414,223,45],[302,478,498,57],[0,537,498,57],[500,537,498,57],[502,181,310,231],[0,320,300,183],[0,0,500,318],[814,181,200,193]]}
];
...
if (reversed == null) { reversed = false; }
	...
	this.instance.setTransform(-130,2,0.52,0.52);

	this.timeline.addTween(cjs.Tween.get(this.instance).wait(1));

	this._renderFirstFrame();

}).prototype = getMCSymbolPrototype(lib.Symbol8, new cjs.Rectangle(-130,2,260,165.4), null);
...
if (reversed == null) { reversed = false; }
	...
	this.instance_7.setTransform(307.45,136.9,1.2224,1.2209,0,0,0,128.8,86);
	this.instance_7.alpha = 0;
	this.instance_7._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_7).wait(219).to({_off:false},0).to({scaleX:0.9717,scaleY:0.9705,x:275.15,y:136.85,alpha:1},10).wait(9));

	// cta
	this.instance_8 = new lib.Symbol10();
	this.instance_8.setTransform(150,269,0.9365,0.9365,0,0,0,63,15.5);
	this.instance_8._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_8).wait(229).to({_off:false},0).to({x:148.95,y:232},8).wait(1));
...
lib.properties = {
	...
	opacity: 1.00,
	manifest: [
		{src:"images/index_atlas_1.png?1599706320792", id:"index_atlas_1"}
	],
	preloads: []
};
