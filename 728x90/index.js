...
lib.ssMetadata = [
		{name:"index_atlas_1", frames: [[285,320,146,85],[285,418,495,62],[0,320,283,118],[0,482,498,45],[500,482,498,45],[0,529,498,45],[782,428,223,45],[502,0,310,231],[502,233,300,183],[0,0,500,318],[804,233,200,193]]}
];
...
if (reversed == null) { reversed = false; }
	...
	this.instance.setTransform(5,1,0.2599,0.2599);

	this.timeline.addTween(cjs.Tween.get(this.instance).wait(1));

	this._renderFirstFrame();

}).prototype = getMCSymbolPrototype(lib.Symbol1, new cjs.Rectangle(5,1,130,82.7), null);
...
}).prototype = getMCSymbolPrototype(lib.Symbol12, new cjs.Rectangle(0,0,249,22.5), null);
...
if (reversed == null) { reversed = false; }
	...
	this.instance_9.setTransform(650.75,21.3,1.2343,1.2343,0,0,0,72.4,20.4);
	this.instance_9.alpha = 0;
	this.instance_9._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_9).wait(84).to({_off:false},0).to({regY:20.5,scaleX:1.0643,scaleY:1.0643,y:21.35,alpha:1},10,cjs.Ease.get(1)).wait(16));
...
p.nominalBounds = new cjs.Rectangle(377,42.4,353.5,103713.70000000001);
// library properties:
lib.properties = {
	...
	opacity: 1.00,
	manifest: [
		{src:"images/index_atlas_1.png?1599707490638", id:"index_atlas_1"}
	],
	preloads: []
};
