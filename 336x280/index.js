...
if (reversed == null) { reversed = false; }
	...
	this.instance.setTransform(-20,0,0.59,0.5899);

	this.timeline.addTween(cjs.Tween.get(this.instance).wait(1));

	this._renderFirstFrame();

}).prototype = getMCSymbolPrototype(lib.Symbol8, new cjs.Rectangle(-20,0,295,187.6), null);
...
if (reversed == null) { reversed = false; }
	...
	this.instance_7.setTransform(168.5,174.05,1.1223,1.1219,0,0,0,123.4,81);
	this.instance_7.alpha = 0;
	this.instance_7._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_7).wait(234).to({_off:false},0).to({regX:123.5,regY:81.2,scaleX:1,scaleY:0.9992,x:166,y:137.2,alpha:1},10).wait(9));
...
lib.properties = {
	...
	opacity: 1.00,
	manifest: [
		{src:"images/index_atlas_1.png?1599707112171", id:"index_atlas_1"}
	],
	preloads: []
};
